    ...
    <div class="auth-inner py-2">
        ...
        <div class="card mb-0">
            <div class="card-body">
                ...
                <p class="card-text mb-2">Create new password that you want</p>
                ...
                <form class="auth-reset-password-form mt-2" method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="john@example.com" aria-describedby="email" tabindex="1" autofocus value="{{ $email ?? old('email') }}" disabled required/>
                        @error('email')
