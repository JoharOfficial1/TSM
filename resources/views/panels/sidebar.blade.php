...
<div class="main-menu menu-fixed {{($configData['theme'] === 'dark') ? 'menu-dark' : 'menu-light'}} menu-accordion menu-shadow" data-scroll-to-active="true">
  ...
  <div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
      <li class="nav-item @if(str_contains(Request::fullUrl(), '/dashboard')) active @endif">
        <a class="d-flex align-items-center" href="{{route('dashboard.index')}}">
          <i data-feather='home'></i>
          <span class="menu-title text-truncate">Dashboard</span>
        </a>
      </li>
      <li class="nav-item @if(str_contains(Request::fullUrl(), '/projects')) active @endif">
        <a class="d-flex align-items-center" href="{{route('projects.index')}}">
          <i data-feather='database'></i>
          <span class="menu-title text-truncate">Projects</span>
        </a>
      </li>
      <li class="nav-item @if(str_contains(Request::fullUrl(), '/tasks')) active @endif">
        <a class="d-flex align-items-center" href="{{route('tasks.index')}}">
          <i data-feather='align-left'></i>
          <span class="menu-title text-truncate">Tasks</span>
        </a>
      </li>
    </ul>
  </div>
